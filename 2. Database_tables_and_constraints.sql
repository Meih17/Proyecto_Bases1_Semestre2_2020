...
(
  ...
  idnumber NUMBER(15) CONSTRAINT phonexperson_idnumber_nn NOT NULL,
...
(
  ...
  AddressID NUMBER(15) CONSTRAINT fk_person_address FOREIGN KEY (AddressID) REFERENCIES PB.Address(AddressID)
);
